...
import CreateCoursePage from './pages/courses/CreateCoursePage'; // ADDED: Import CreateCoursePage
                  ...
                  <ProtectedRoute>
                    <Layout>
                      <Routes>
                        ...
                        {/* UPDATED: Course Routes - urutan penting! /courses/create harus sebelum /courses/:id */}
                        ...
                        {/* Forum Routes - Urutan penting! /forums/create harus sebelum /forums/:id */}
